...
//	}
	...
	public CustomerWindow(String a,String b,String c,String d,String e,String f,String g,String customerName) {
		...
		comboBox.setModel(new DefaultComboBoxModel(new String[] {"Alexandria","Cairo","Luxor","Aswan","SharmElShaikh","Hurghada","Sinai"}));
		...
		btnNewButton_4.setBackground(new Color(82,179,217));
		...
		btnNewButton_4.setBounds(20, 132, 196, 40);
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				else
				{
					...
					if(!identicalTrips[0].equals(null))
						textField.setText(identicalTrips[0]+" "+identicalTrips[1]+" "+identicalTrips[2]+" "+identicalTrips[4]+" "+identicalTrips[5]+" "+identicalTrips[6]+" "+identicalTrips[7]);
					else
						textField.setText("No trips are avilable");
					if(!identicalTrips[8].equals(null))
						textField_1.setText(identicalTrips[8]+" "+identicalTrips[9]+" "+identicalTrips[10]+" "+identicalTrips[12]+" "+identicalTrips[13]+" "+identicalTrips[14]+" "+identicalTrips[15]);
					else
						textField_1.setText("No trips are avilable");
					if(!identicalTrips[16].equals(null))
						textField_2.setText(identicalTrips[16]+" "+identicalTrips[17]+" "+identicalTrips[18]+" "+identicalTrips[20]+" "+identicalTrips[21]+" "+identicalTrips[22]+" "+identicalTrips[23]);
					else
						textField_2.setText("No trips are avilable");
					}
					catch(Exception e6)
